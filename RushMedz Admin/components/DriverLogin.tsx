...
export default function DriverLogin({ onSwitchToSignup, onBackToRoleSelector }: DriverLoginProps) {
  const { signIn, loading, error, clearError, sendOTP, verifyOTP, resendOTP } = useDriverAuth();
      ...
      >
        <View style={styles.content}>
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>Epharma Delivery</Text>
          </View>
          ...
          <View style={styles.form}>
            ...
            <View style={styles.demoBox}>
              ...
              <Text style={styles.demoText}>Email: driver@epharma.com</Text>
...
const styles = StyleSheet.create({
  ...
  forgotPasswordText: { color: '#45B7D1', fontSize: 14, fontWeight: '500' },
  loginButton: { backgroundColor: '#45B7D1', borderRadius: 8, padding: 16, alignItems: 'center', marginBottom: 16 },
  ...
  signupLink: { color: '#45B7D1', fontSize: 14, fontWeight: 'bold' },

...
- **Working branch**: appmod/java-upgrade-20251128044211
...
**Target JDK path (Java 21)**: C:\Java\jdk-21.0.8\bin
...
1. Set up the development environment using tool #setup_upgrade_environment.
    ...
    - Create working branch `appmod/java-upgrade-20251128044211`.
